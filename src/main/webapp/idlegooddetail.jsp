            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $("#makeOrderInfo").prepend("<div class=\"form-group\">" +
                        ...
                        "<div class=\"img-box\"><img src=" + goodsDetailInfo.goodsCoverImgDir + " alt=\"\"></div>\n" +
                        "<div class=\"detail-box\">\n" +
                        "<h5><a href=\"idlegooddetail.jsp?goodsId=" + goodsDetailInfo.goodsId + "\" style='max-width: 420px; display: block; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; color: #303841'>" + goodsDetailInfo.goodsName + "</a></h5>\n" +
                        "<div class=\"detail-info\">\n" +
                        "<h6><i class=\"fa fa-user-circle-o\" aria-hidden=\"true\"></i><span>" + goodsDetailInfo.user.userName + "</span></h6>\n" +
                        "<h6><i class=\"fa fa-map-marker\" aria-hidden=\"true\"></i><span>" + goodsDetailInfo.goodsProvince + "</span></h6>\n" +
                        "<h6><i class=\"fa fa-money\" aria-hidden=\"true\"></i><span>￥" + goodsDetailInfo.goodsPrice + "/RMB</span></h6>\n" +
                        "</div>\n" +
                        "</div>\n" +
                        "</div>\n" +
                        "<div class=\"option-box\">\n" +
                        "<a href=\"idlegooddetail.jsp?goodsId=" + goodsDetailInfo.goodsId + "\" class=\"apply-btn\">查看</a>\n" +
                        "</div>\n" +
                        "</div></div>");
                },
            });
...
<script type="text/javascript">
            ...
            success: function (result) {
                ...
                $('.M-box11').pagination({
                    ...
                    callback: function (api) {
                        getPageIdleGoodsItem(api.getCurrent());
                    }
                });
            },
        });
    ...
    function getPageIdleGoodsItem(pageNum) {
        $.ajax({
            type: "post",
            url: "getidlegoodslist",
            data: {
            ...
            success: function (result) {
                ...
                for (var i = 0; i < idleGoodsList.length; i++) {
                    str += "<div class=\"box\" " + (idleGoodsList[i].goodsStatus != "1" ? "style=\"background-image: url('assets/images/watermark.png')\"" : "") + ">\n" +
                        ...
                        "<div class=\"detail-box\">\n" +
                        "<h5><a style = \"color: #303841\" href=\"idlegooddetail.jsp?goodsId=" + idleGoodsList[i].goodsId + "\">" + idleGoodsList[i].goodsName + "</a></h5>\n" +
                        "<div class=\"detail-info\">\n" +
